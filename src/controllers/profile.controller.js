...
export const createProfile = async (req, res) => {
    ...
    try {
        const crearPerfil = await ProfileModel.create({name, edad, pais, description});
...
export const getAllPerfil = async (req, res) => {
    try {
        const obtenerPerfiles = await ProfileModel.find();
...
export const getByIdPerfil = async (req, res) => {
    const {id} = req.params
    try {
        const obtenerIdPerfil = await ProfileModel.findById(id)
